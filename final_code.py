...
for test_i in np.arange(0, test_df.shape[0]):
...
test_df['solution']=self_solution
test_df['score']=self_scores
test_df['steps']=self_steps

pd.to_pickle(test_df, "./test_data_result.pickle")  # doctest: +SKIP
